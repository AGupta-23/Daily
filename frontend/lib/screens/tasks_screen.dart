          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailRow(
                    Icons.access_time, 'Time', task.datetime.toString()),
                _buildDetailRow(
                    Icons.timer, 'Duration', '${task.durationMinutes} minutes'),
                _buildDetailRow(
                  Icons.flag,
                  'Priority',
                  task.priority.name,
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Task content', border: OutlineInputBorder()),
                maxLines: 3,
              ),
              const SizedBox(height: 16),
              ...
              onPressed: () async {
                if (contentController.text.trim().isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text('Please enter task content')));
                  return;
                }
                final messenger = ScaffoldMessenger.of(context);
